            ...
            <div className="container mx-auto flex items-center">
              ...
              <div className="flex w-1/2 pl-4 text-md">
                <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
                  <li className="mr-2">
                  <Link href='/posts/first-post' className="inline-block py-2 px-2 text-gray-600 no-underline hover:text-gray-400">POSTS</Link>
                  </li>
                  <li className="mr-2">
          ...
          <div className="mx-0 sm:mx-6">
            ...
            <div className="bg-gray-200 w-full text-xl md:text-2xl text-gray-800 leading-normal rounded-t">
              ...
              <div className="container font-sans bg-yellow-100 rounded my-8 p-4 mx-auto md:p-24 text-center">
                <h2 className="font-bold break-normal text-2xl md:text-4xl">Follow me on InstaGram Fakas</h2>
                <h3 className="font-bold break-normal font-normal text-gray-600 text-base md:text-xl">Or I'll kill you</h3>
                <div className="w-full text-center pt-4">
                  <form action="#">
                    <div className="max-w-xl mx-auto p-1 pr-0 flex flex-wrap items-center">
                      ...
                      <button type="submit" className="flex-1 mt-4 md:mt-0 block md:inline-block appearance-none bg-yellow-500 text-white text-base font-semibold tracking-wider uppercase py-4 rounded shadow hover:bg-yellow-400">Subscribe</button>
                    </div>
                  </form>
                </div>
              </div>
